...
function Pratos() { 
   ...
   const [listaProdutos, setListaProdutos] = useState(retornaProdutos());
 ...
 function filtro(produto){
  ...
  useEffect(()=> {
    setListaProdutos(filtrarProduto("Entradas"))
  }, [])
        ...
        <main className="container-menus">
            ...
            <nav>
                ...
                <div className="container-input">
                    ...
                    <input type="text" id="text" value={textoBusca}  onChange={(event) => buscaProduto(event.target.value)} className="text" placeholder="Pesquise aqui um dos pratos do nosso cardápio"/>
                </div>
          
                <h2>Cardápio</h2>
                  <div className="container-produtos">
                    <section className="itens-produtos">
                      {listaProdutos.map((produto) => <ItemPratos
                      key={produto.id}
                      nome={produto.nome}
